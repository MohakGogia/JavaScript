...
const IntersectionDemo = () => {
  let conditionObject = {
    ...
    threshold: "0.8", // >=80% cover hogi screen p video tbhi true hoga isInteresecting
  };

  function cb(entries) {
    // console.log(entries);
    //entries m sb videos k info arhi h
  ...
  useEffect(() => {
    ...
    let elements = document.querySelectorAll(".video-container"); // jise observe krna h
